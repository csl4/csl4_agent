...
# 与 config.DEFAULT_CONFIG_DIR(~/.agent) 对齐。
DEFAULT_LOG_DIR = Path.home() / ".agent" / "logs"
...
def setup_logging(
    ...
    *,
    ...
    参数:
        ...
        log_dir: 文件日志目录。None 时取 AGENT_LOG_DIR，再默认 ~/.agent/logs。
