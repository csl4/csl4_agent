...
from GSagent.core.transformers import LineCountTransformer
from GSagent.plugins.toolsets.bash.common.bash import execute_bash_command
...
def _merge_cli_approved_prefixes(context: ToolInvokeContext) -> None:
    """将 ./.GSagent/bash_approved_prefixes.yaml 中的 CLI 已批准前缀
    合并到工具集的 allow 列表中。"""
    toolset = getattr(context, "toolset", None)
